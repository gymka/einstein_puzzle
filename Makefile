...
install: $(TARGET)
	...
	$(INSTALL) -D einstein.png $(PREFIX)/share/pixmaps/einstein.png
	echo "[Desktop Entry]">$(PREFIX)/share/applications/einstein.desktop
	echo "Encoding=UTF-8">>$(PREFIX)/share/applications/einstein.desktop
	echo "Name=Einstein">>$(PREFIX)/share/applications/einstein.desktop
	echo "GenericName=Einstein">>$(PREFIX)/share/applications/einstein.desktop
	echo "Comment=Einstein puzzle">>$(PREFIX)/share/applications/einstein.desktop
	echo "Exec=$(PREFIX)/bin/$(TARGET)">>$(PREFIX)/share/applications/einstein.desktop
	echo "Icon=einstein">>$(PREFIX)/share/applications/einstein.desktop
	echo "Terminal=false">>$(PREFIX)/share/applications/einstein.desktop
	echo "Type=Application">>$(PREFIX)/share/applications/einstein.desktop
	echo "Categories=GNOME;GTK;Game;LogicGame;">>$(PREFIX)/share/applications/einstein.desktop
	echo "StartupNotify=false">>$(PREFIX)/share/applications/einstein.desktop
	chmod a+x $(PREFIX)/share/applications/einstein.desktop
