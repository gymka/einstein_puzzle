...
class FailCommand: public Command
{
    ...
    public:
        ...
        virtual void doAction() {
            ...
            area.add(new Button(225, 340, 110, 25, &btnFont, 255,255,0, 
                        L"redpattern.bmp", msg(L"startNew"), &newGameCmd));
            OkDlgCommand restartCmd(&area, restart);
            area.add(new Button(343, 340, 114, 25, &btnFont, 255,255,0, 
                        L"redpattern.bmp", msg(L"tryAgain"), &restartCmd));
            ExitCommand exitCmd(area);
            area.add(new Button(465, 340, 110, 25, &btnFont, 255,255,0, 
