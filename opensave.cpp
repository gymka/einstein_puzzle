...
class SaveCommand: public Command
{
    ...
    public:
        virtual void doAction() {
            ...
            area.add(new Window(190, 280, 480, 100, L"blue.bmp"));
            std::wstring name;
            if (savedGame.isExists())
                name = savedGame.getName();
            else
                name = defaultName;
            area.add(new Label(font, 200, 300, 255,255,0, msg(L"enterGame")));
            area.add(new InputField(380, 300, 280, 26, L"blue.bmp",name, 20,  
                        255,255,0,  font));
